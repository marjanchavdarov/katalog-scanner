    ...
    <SafeAreaView style={styles.container}>
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <Animated.View style={[styles.stepWrap, { opacity: fadeAnim }]}>
          ...
          <TextInput style={styles.input} placeholder="+385 91 234 5678" placeholderTextColor={colors.muted} value={phone} onChangeText={setPhone} keyboardType="phone-pad" autoFocus />
    ...
    <SafeAreaView style={styles.container}>
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <Animated.View style={[styles.stepWrap, { opacity: fadeAnim }]}>
          ...
          <TextInput style={[styles.input, styles.codeInput]} placeholder="• • • • • •" placeholderTextColor={colors.border} value={code} onChangeText={setCode} keyboardType="number-pad" maxLength={6} autoFocus />
          {!!error && <Text style={styles.error}>{error}</Text>}
...
const styles = StyleSheet.create({
  ...
  welcomeWrap: { flex: 1 },
  mascotWrap: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: colors.primaryLight, borderBottomLeftRadius: 40, borderBottomRightRadius: 40, minHeight: 320 },
  ...
  primaryBtn: { backgroundColor: colors.primary, borderRadius: 18, padding: 18, alignItems: 'center', marginBottom: 12, shadowColor: colors.primary, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.35, shadowRadius: 12, elevation: 6 },
  primaryBtnText: { color: '#fff', fontWeight: '800', fontSize: 17 },
  terms: { fontSize: 11, color: colors.muted, textAlign: 'center' },
  stepWrap: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: 28 },
  ...
  input: { width: '100%', borderWidth: 1.5, borderColor: colors.border, borderRadius: 16, padding: 18, fontSize: 18, color: colors.ink, backgroundColor: colors.bg, marginBottom: 12 },
